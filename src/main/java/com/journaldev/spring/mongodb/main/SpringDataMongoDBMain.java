...
public class SpringDataMongoDBMain {
	...
	public static void main(String[] args) {
		try {
			...
			Person p01 = new Person("113", "PankajKr", "Bangalore, India");
			Person p02 = new Person("114", "JohnKar", "Fairfax, USA");
			
			mongoOps.insert(p01, PERSON_COLLECTION);
			mongoOps.insert(p02, PERSON_COLLECTION);
